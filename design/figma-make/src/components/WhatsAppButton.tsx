export default function WhatsAppButton() {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-5 right-5 z-40 bg-[#25D366] text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:scale-105 transition-transform"
      aria-label="WhatsApp"
    >
